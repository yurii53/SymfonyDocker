 ...
 */
final class Version20220730203054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, quote_author_id INT DEFAULT NULL, quote LONGTEXT NOT NULL, historian LONGTEXT NOT NULL, year INT NOT NULL, address LONGTEXT NOT NULL, INDEX IDX_6B71CBF4F675F31B (author_id), INDEX IDX_6B71CBF471976A61 (quote_author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
